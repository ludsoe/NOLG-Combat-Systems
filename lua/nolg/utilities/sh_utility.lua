...
local NOLG = NOLG or {} --Localise the global table for speed.
NOLG.Utl = {} --Make a Utility Table.
...
local DTable = NOLG.Utl.DebugTable --Localise the debug storage.
local HTable = NOLG.Utl.Hooks --Localise the hook table for speed.
...
function Utl:Debug(Source,String,Type)
	NOLG.Debug(String,2,"["..Type.."]"..Source)--Redirect this to use the debug.lua debug functions.
